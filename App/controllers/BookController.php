   ...
   public function create()
{
    ...
    // Recebe dados do POST (multipart ou json)
    ...
    $caminho_arquivo_s3 = null;
    $capa_arquivo_s3 = null;
    ...
    if (isset($_FILES['caminho_arquivo']) && $_FILES['caminho_arquivo']['error'] === UPLOAD_ERR_OK) {
        ...
        try {
            ...
            echo json_encode(["error" => "Falha no upload do livro: " . $e->getMessage()]);
            return;
        }
    }
    ...
    // Agora  cria o registro no banco
