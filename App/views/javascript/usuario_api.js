async function cadastrarUsuario() {
    ...
    form.addEventListener("submit", async event => {
        ...
        try {
            const res = await fetch("http://15.228.40.136/TimerBook/public/register", {
                method: "POST",
                body: formData
            } );
...
async function loginUsuario() {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            const adminRes = await fetch("http://15.228.40.136/TimerBook/public/admin/login", {
                method: "POST",
            ...
            const userRes = await fetch("http://15.228.40.136/TimerBook/public/login", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ email, password })
            });
...
async function redefinirSenha(){
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            try {
                const res = await fetch("http://15.228.40.136/TimerBook/public/forgot-password", {
                    method: "POST",
