async function cadastrarUsuario() {
    ...
    const res = await fetch("http://localhost/TimerBook/register", {
        method: 'POST',
        body: formData
    });
...
async function loginUsuario() {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            const adminRes = await fetch("http://localhost/public/admin/login", {
                method: "POST",
            ...
            const userRes = await fetch("http://localhost/public/login", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ email, password })
            });
...
async function redefinirSenha(){
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            try {
                const res = await fetch("http://localhost/public/forgot-password", {
                    method: "POST",
