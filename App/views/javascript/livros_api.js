async function cadastrarLivro() {
    ...
    try {
        const res = await fetch("http://15.228.40.136/TimerBook/public/books", {
            method: "POST",
            body: formData,
...
async function deletarLivro(id) {
    ...
    try {
        ...
        const res = await fetch(`http://15.228.40.136/TimerBook/public/books/${id}`, {
            method: "DELETE",
...
async function listarLivrosUsuario(user_id) {
    try {
        const res = await fetch(`http://15.228.40.136/TimerBook/public/my-books`, {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            credentials: "include"
        });
...
async function editarLivro(id_livro) {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        try {
            const res = await fetch(`http://15.228.40.136/TimerBook/public/books/${id_livro}`, {
                method: "POST",
                body: formData,
                credentials: "include"
            });
...
async function listarLivrosAdmin(id) {
    try {
        const res = await fetch(`http://15.228.40.136/TimerBook/public/books/user/${id}`, {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            credentials: "include"
        });
